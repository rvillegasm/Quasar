...
layout(location = 5) in int a_EntityID; // for the editor
...
void main()
{
    // this is necessary because GLSL 1.30 and aboves does not allow indexing sampler arrays using non-constant values
